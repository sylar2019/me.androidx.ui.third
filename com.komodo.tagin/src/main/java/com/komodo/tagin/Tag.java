...
public class Tag implements Comparable<Tag> {
    ...
    public Tag() {
        this("", 0f, 0f, 0f, 1.0f, 0, null);
    }

    public Tag(String text, Object obj) {
        this(text, 0f, 0f, 0f, 1.0f, DEFAULT_POPULARITY, obj);
    }

    public Tag(String text, int popularity) {
        this(text, 0f, 0f, 0f, 1.0f, popularity, null);
    }
    ...
    public Tag(String text, float locX, float locY, float locZ) {
        this(text, locX, locY, locZ, 1.0f, DEFAULT_POPULARITY, null);
    }

    public Tag(String text, float locX, float locY, float locZ, float scale) {
        this(text, locX, locY, locZ, scale, DEFAULT_POPULARITY, null);
    }
